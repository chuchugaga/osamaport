  ...
  render () {
    return (
      <div>
        ...
        <AboutHalfImage challenge="Challenge" challengeDesc="To enter the market with a splash and increase brand awareness." truth="Insight" truthDesc="People love an underdog story. Mild controversy attracts attention." concept="Concept" conceptDesc="Take photos of our products outside big-name restaurants and cafes. Pair each photo with one-liners in the caption." img={reasonCover} title="About Maro" approachTitle="Campaign" impactTitle="Impact" projInsights={[{number: '0 $' , title: 'Budget'}, {number: 550000 , title: 'Clicks'}, {number: 17000 , title: 'Likes'}, {number: 4200 , title: 'Shares'}, {number: 1800 , title: 'Comments'}]} approach={[{title: 'Optimized Images' , description: 'The image sequences were optimized to guide the audience through the album and ensure that the most eye-catching brands were at the start and end.', img: reason1},{title: 'Use of competitor logos' , description: 'Indirect use of competitor logos ruffled feathers and provoked debate. This generated even more attention than anticipated.', img: reason2},{title: 'Taking on the big boys' , description: 'Our audience cheered for the newcomer taking on the big boys – which was exactly what we hoped for as a startup.', img: reason3}]} logo={maro} description="MARO Tandoors is a food startup whose original proposition was to offer standardized naan bread, a staple food across Southeast Asia. They catapulted to national fame when they started selling innovative new products such as the Nutella Naan, promoted by quirky marketing campaigns" titleMethod="Methods & Measurements" methods={["Interviews", "Color psychology research", "User journey simulation", "Copy testing", "Sales data mapping" , "Bounce rate measurement"]} titleAgg="Aggregated Impact at Maro" aggregate={["Market leader in the ‘tandoor’ space", "17x growth in social media audience within 1 year", "2 million+ views across campaigns", "4x growth in sales"]} />
        ...
        <Footer dropEmail="Drop me an email" lookingForward="I'm looking forward to speaking to you" email="uwaheed@nyu.edu" navTitle="Navigation" navigation={[{name: 'Portfolio', linkTo: './portfolio'}, {name: 'About', linkTo: './about'}, {name: 'Home', linkTo: './'}]} socTitle="Social" footerSocial={[{name: 'LinkedIn', ClassName: 'In'}, {name: 'Upwork', ClassName: 'Up'}]}/>
      </div>
    )
  }
}
